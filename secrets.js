...
async function accessSecrets(){
    if(process.env.NODE_ENV==='production'){
        let secrets=['COWIN_DB_HOST','COWIN_DB_PORT','COWIN_DB_USERNAME','COWIN_DB_PASSWORD','COWIN_DB_DATABASE','COWIN_SENDGRID_API_KEY','COWIN_SENDER_EMAIL','COWIN_SENDER_NAME','COWIN_MIN_NOTIFY_DELAY_SECS'];
